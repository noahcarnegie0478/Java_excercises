/**
 * TASK: Array List Length
 * Source image: exercise/linked-lists/e-30-ArrListLen.png
 *
 ...
 * that, given a non-empty array A consisting of N integers, returns the length of
 * the list constructed from A in the above manner.
 *
